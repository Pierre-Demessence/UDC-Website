-- CreateEnum
CREATE TYPE "Role" AS ENUM ('USER', 'TUTORIAL_CREATOR', 'TUTORIAL_MODERATOR', 'ADMIN');
...
CREATE TABLE "GameJam" (
    ...
    "itchIoUrl" TEXT NOT NULL,
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,

    CONSTRAINT "GameJam_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE UNIQUE INDEX "Rating_userId_tutorialId_key" ON "Rating"("userId", "tutorialId");
